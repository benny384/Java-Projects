...
public class Tankpreis {
    public static void main(String[] args) {
        ...
        System.out.println("Wie viel passt in deinen Tank? In Liter");
        String read1 = scanner.next();
        //tankinhalt = scanner.nextDouble();


        System.out.println("Wie viel ist dein Verbrauch pro 100km? In Liter");
        String read2 = scanner.next();
        //verbrauchProEins = Double.parseDouble(scanner.next()) / 100;


        System.out.println("Wie lange ist die Strecke? In km");
        String read3 = scanner.next();
        //strecke = scanner.nextDouble();


        System.out.println("Wie viel kostet ein Liter? In Euro");
        ...
        if (read1.contains("-") || read2.contains("-") || read3.contains("-") || read4.contains("-")) {
            ...
            if (literConsumed >= 0) {
                ...
                System.out.println("Dies kostet dich: " + (Math.round((literConsumed * benzinpreis) * 100.0) / 100.0) + "Euro ");
            }
        }
    }
}